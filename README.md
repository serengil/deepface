...
Experiments show that human beings have 97.53% accuracy on facial recognition tasks whereas those models already [reached and passed](https://github.com/serengil/deepface/tree/master/benchmarks) that accuracy level.
