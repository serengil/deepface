...
The default cache directory where the model weights are stored is ~/.deepface/weights. Change the cache location by setting the environment variable `DEEPFACE_HOME` to another directory.

```
export DEEPFACE_HOME="/path/to/your/directory"
```
