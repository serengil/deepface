...
You can store facial embeddings in nosql databases. In this way, you can have the power of the map reduce technology of nosql databases. Here, you can find some implementation experiments with [mongoDb](https://sefiks.com/2021/01/22/deep-face-recognition-with-mongodb/) and [Cassandra](https://sefiks.com/2021/01/24/deep-face-recognition-with-cassandra/).
